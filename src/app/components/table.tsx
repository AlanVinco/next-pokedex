    ...
    <div className="">
      <div className="flex justify-center py-5">
        ...
        <div className="type-container">
          <div className="type-box bg-gradient-to-r from-[#EE8130] to-red-200 rounded-xl">
            FIRE
          </div>
          <div className="type-box bg-gradient-to-r from-[#A8A77A] to-red-200 rounded-xl">
            NORMAL
          </div>
          <div className="type-box bg-gradient-to-r from-[#C22E28] to-red-200 rounded-xl">
            FIGHTING
          </div>
          <div className="type-box bg-gradient-to-r from-[#A33EA1] to-red-200 rounded-xl">
            POISON
          </div>
          <div className="type-box bg-gradient-to-r from-[#E2BF65] to-red-200 rounded-xl">
            GROUND
          </div>
          <div className="type-box bg-gradient-to-r from-[#B6A136] to-red-200 rounded-xl">
            ROCK
          </div>
          <div className="type-box bg-gradient-to-r from-[#A6B91A] to-red-200 rounded-xl">
            BUG
          </div>
          <div className="type-box bg-gradient-to-r from-[#735797] to-red-200 rounded-xl">
            GHOST
          </div>
          <div className="type-box bg-gradient-to-r from-[#B7B7CE] to-red-200 rounded-xl">
            STEEL
          </div>
          <div className="type-box bg-gradient-to-r from-[#B7B7CE] to-red-200 rounded-xl">
            WATER
          </div>
          <div className="type-box bg-gradient-to-r from-[#7AC74C] to-red-200 rounded-xl">
            GRASS
          </div>
          <div className="type-box bg-gradient-to-r from-[#F7D02C] to-red-200 rounded-xl">
            ELECTRIC
          </div>
          <div className="type-box bg-gradient-to-r from-[#F95587] to-red-200 rounded-xl">
            PSYCHIC
          </div>
          <div className="type-box bg-gradient-to-r from-[#96D9D6] to-red-200 rounded-xl">
            ICE
          </div>
          <div className="type-box bg-gradient-to-r from-[#6F35FC] to-red-200 rounded-xl">
            DRAGON
          </div>
          <div className="type-box bg-gradient-to-r from-[#705746] to-red-200 rounded-xl">
            DARK
          </div>
          <div className="type-box bg-gradient-to-r from-[#D685AD] to-red-200 rounded-xl">
            FAIRY
          </div>
          <div className="type-box bg-gradient-to-r from-[#A98FF3] to-red-200 rounded-xl">
            FLIYING
          </div>
        </div>
        {allDataPokemon.length > 0 && !pokemonError && 
            <div className="box-container rounded-md shadow-2xl">
            {allDataPokemon?.map((elements:any) => (
            <Link href={`pokedex/${elements.name}`} key={elements.name}>
              <div className="pokemon-container hover:animate-bounce shadow-2xl">
